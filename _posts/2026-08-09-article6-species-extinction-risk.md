...
Three methods working together, each answering a different version of the same question. I used Random forest method and SHAP value analysis to understand the dataset and extract information from it. 
